...
export default function LoansPage() {
    ...
    const handleCancelEdit = () => {
        ...
        setLoanForm({ lenderName: '', linkedProperty: '', loanType: 'HOME', originalAmount: '', outstandingBalance: '', interestRate: '', emiAmount: '', emiDueDate: '1', loanStartDate: '', loanEndDate: '', notes: '' });
